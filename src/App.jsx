...
const App = () => {
  ...
  function handleChange(e) {
    ...
    if (e.target.value === "none") {
      setUseLink(
        "https://api.themoviedb.org/3/movie/now_playing?language=en-US&page="
      ); //change to change at the lower level
  ...
  return (
    <div className="App">
      ...
      <footer>
        <span>
          All Rights Reserved | About: Flixter connects with the TMDB API to
          show movies. You can search, sort, and see more details on any movie
          you want. |{" "}
        </span>
        <span>
